            ...
            <form method="POST" action="{{ route('agents.store') }}">
                ...
                <div class="row g-3 mt-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="matricule_solde" value="{{ old('matricule_solde') }}" class="form-control @error('matricule_solde') is-invalid @enderror">
                        @error('matricule_solde')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Lieu d'affectation</label>
                        <input type="text" name="lieu_affectation" value="{{ old('lieu_affectation') }}" class="form-control @error('lieu_affectation') is-invalid @enderror">
                ...
                <div class="row g-3 mt-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="ufr" value="{{ old('ufr') }}" class="form-control">
                    </div>
                </div>
                ...
                <div class="row g-3 mt-3">
                    <div class="col-md-4">
                        ...
                        <input type="date" name="date_prise_service" value="{{ old('date_prise_service') }}" class="form-control @error('date_prise_service') is-invalid @enderror">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="date" name="date_cessation_service" value="{{ old('date_cessation_service') }}" class="form-control">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Date de reprise de service</label>
                        <input type="date" name="date_reprise_service" value="{{ old('date_reprise_service') }}" class="form-control">
                    </div>
                </div>
                ...
                <div class="row g-3 mt-3">
                    <div class="col-md-3">
                        ...
                        <input type="number" name="jours_conges_dus" value="{{ old('jours_conges_dus', 0) }}" class="form-control @error('jours_conges_dus') is-invalid @enderror">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="jours_ouvrables_a_prendre" value="{{ old('jours_ouvrables_a_prendre', 0) }}" class="form-control @error('jours_ouvrables_a_prendre') is-invalid @enderror">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="absences_a_defalquer" value="{{ old('absences_a_defalquer', 0) }}" class="form-control @error('absences_a_defalquer') is-invalid @enderror">
                        @error('absences_a_defalquer')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Nombre d'enfants</label>
                        <input type="number" name="enfants" value="{{ old('enfants', 0) }}" class="form-control @error('enfants') is-invalid @enderror">
